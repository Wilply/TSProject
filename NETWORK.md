...
"hello <texte>" : fait renvoyer le texte spécifié par le serveur. Utilisé comme "ping" à des fins de test :
(E) Node : OK Hello user ! You said <texte>

"whoami" : fait renvoyer par le Node l'identité du client. Utilisé à des fins de test :
(E) Node : OK You are <identité du client>
